...
public class VistaAdministrador extends JPanel {
    ...
    private void initDisplay() {
        ...
        // crear a partir de base de datos
    ...
    private JPanel createDoctorCard(Doctor doctor) {
        ...
        //funcionalidad de eliminar crear y editar a partr de la base de datos 
        JPanel infoPanel = new JPanel(new GridLayout(3, 1));
        infoPanel.add(cityLabel);
        infoPanel.add(addressLabel);
        infoPanel.add(contact);
        infoPanel.add(eliminar);
        infoPanel.add(editar);
